...
let sofa = { img: "sofafürWohnzimmer.jfif", artikelname: "Sofa", spruch: "gemütlich groß- entspann dich mal wieder so richtig", preis: "259.00€" };
...
let holzhocker = { img: "holzohocker.webp", artikelname: "Holzhocker im Landhausstil", spruch: "bequem und schick- gebe deinem Büro einen besonderen Hingucker", preis: "35€" };
...
let regal = { img: "regalmetall.webp", artikelname: "weißes Regal", spruch: "immer schön- ein weißes Regal braucht doch wirklich jeder", preis: "9.99€" };
...
let schreibtischartikel = [tischbeine, holzhocker, stuhl, tischplatte, regal, kommode, posterset, lampe, blumentopf, topfset];
//wohnzimmerartikel
...
//schreibtischartikel
for (let index = 0; index < schreibtischartikel.length; index++) {
    //DIV
    let newDiv = document.createElement("div");
